...
public class ArtistDetailsActivity extends AppCompatActivity {
    @BindView(R.id.artist_poster) ImageView posterImageView;
    @BindView(R.id.artist_name) TextView nameTextView;
    @BindView(R.id.artist_albums) TextView albumsTextView;
    @BindView(R.id.artist_tracks) TextView tracksTextView;
    @BindView(R.id.artist_description) TextView descriptionTextView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setArtist(((SampleApplication)getApplication()).getApi().getArtists()[intent.getIntExtra("id",0)]);
    }
