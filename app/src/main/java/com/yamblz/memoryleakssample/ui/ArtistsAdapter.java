...
import com.yamblz.memoryleakssample.utill.ShadowTransform;
...
public class ArtistsAdapter extends RecyclerView.Adapter<ArtistsAdapter.ArtistVH> {
    ...
    private ShadowTransform shadowTransform;
    ...
    public void setArtists(@NonNull Artist[] artists) {
